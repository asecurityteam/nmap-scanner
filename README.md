...
# (string) Relative path to nmap scripts directory where custom scripts are stored.
NMAPSCANNER_SCRIPTPREFIX="custom/"
# (string) File path where custom scripts are located
NMAPSCANNER_SCRIPTDIR="/usr/local/share/nmap/scripts/custom"
...
# (string)
NMAPSCANNER_STORE_DYNAMODB_ENDPOINT=""
# (string) AWS region in which the table is provisioned.
NMAPSCANNER_STORE_DYNAMODB_REGION=""
